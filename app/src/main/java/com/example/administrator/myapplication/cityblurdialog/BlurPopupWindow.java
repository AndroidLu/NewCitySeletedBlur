...
//        mContentLayout.setBackgroundColor(getContext().getResources().getColor(R.color.wheel_timebtn_nor));
        ...
        public T build() {
            ...
            if (mContentView != null) {
                ...
                if (layoutParams == null || !(layoutParams instanceof LayoutParams)) {
                    layoutParams = new LayoutParams(layoutParams.width, layoutParams.MATCH_PARENT);
                }
                if (mGravity != -1) {
