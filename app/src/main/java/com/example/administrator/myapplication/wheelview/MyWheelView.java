...
public class MyWheelView extends View {
	...
	private int[] SHADOWS_FONT_SIZE = new int[] { 16,
			16, 16 };
	private int[] SHADOWS_COLORS = new int[] { 0xcfffffff,
...
//		canvas.drawLine(0, center + offset, getWidth(), center + offset, paint);
		...
		Paint paint = new Paint();
		paint.setColor(getResources().getColor(R.color.line_current_color));
		// 设置线宽
		paint.setStrokeWidth((float) 2);
		// 绘制上边直线
		canvas.drawLine(0, center - offset, getWidth(), center - offset, paint);
		...
		paint2.setColor(getResources().getColor(R.color.bg_current_color));
		paint2.setStrokeWidth((float)102);
		canvas.drawLine(0, center, getWidth(), center , paint2);
	}
